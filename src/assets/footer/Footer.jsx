    ...
    <section className={style.footer}>
      <div className='container-fluid d-flex justify-content-between gap-5' >
        <div className='d-flex flex-column gap-5 w-25 '>
          <h3 className='fw-bold text-center'>Location</h3>
          <p>2215 John Daniel Drive
            Clark, MO 65243</p>
        </div>
        <div className='d-flex flex-column gap-5'>
          <h3 className='fw-bold text-center'>Around the Web</h3>
         ...
         <div className='d-flex flex-column gap-5 w-25'>
          <h3 className='fw-bold text-center'>About Freelancer</h3>
          <p>Freelance is a free to use,
             MIT licensed Bootstrap theme created by Start Bootstrap</p>
        </div>
      </div>
    </section>)
}
